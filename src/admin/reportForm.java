...
public class reportForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(individual, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 360, 100, 40));
        ...
        jPanel1.add(print, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 360, 100, 40));
    ...
    private void individualMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_individualMouseClicked
        ...
        if(rowindex < 0){
            ...
            if(desktopPane != null){
                ...
                individualPrinting aa = new individualPrinting();
